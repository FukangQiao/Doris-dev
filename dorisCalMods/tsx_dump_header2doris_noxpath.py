...
#              'dopplerCoeff2':'.//combinedDoppler/coefficient[@exponent="2"]',\
	     # Center frequency
	     'fc'          :'.//instrument/radarParameters/centerFrequency',\
	     # Calibration factor to convert beta0 to sigma0
	     'calFactor' :'.//calibration/calibrationConstant/calFactor',\
             }
...
print('Radar_wavelength (m):                      	%0.3f' % lightSpeed/(float(container['fc'][0])))
...
print('Calibration_constant: 				%s' % container['calFactor'][0])
print('')
print('*******************************************************************')
